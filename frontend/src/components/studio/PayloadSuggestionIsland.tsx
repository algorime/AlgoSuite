...
interface PayloadSuggestionIslandProps {
...
const PayloadSuggestionIsland: React.FC<PayloadSuggestionIslandProps> = ({
  httpRequest,
  httpResponse,
  onPayloadApply,
  onPayloadSave,
            ...
            {payload.source && (
              <div>
                ...
                {expandedSource === index && (
                  <div className="mt-2 p-2 bg-black/30 rounded text-xs opacity-80 whitespace-pre-wrap">
                    {payload.source}
                  </div>
                )}
              </div>
    ...
    >
      ...
      <div className="pb-4 border-b border-gray-600 mb-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">Payload Suggestor</h3>
          <div className="flex items-center space-x-2">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 mb-4">
        {messages.length === 0 ? (
          <div className="text-center opacity-80 mt-8">
            <div className="mb-4">
...
export default PayloadSuggestionIsland;